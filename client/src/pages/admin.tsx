          ...
          <Card key={meal.id} className="overflow-hidden">
            ...
            <CardContent className="p-3 sm:p-4">
              ...
              <div className="text-sm text-slate-600">
                ...
                <strong>Ingredients:</strong> {Array.isArray(meal.ingredients) ? meal.ingredients.length : 0}<br />
                <strong>Steps:</strong> {Array.isArray(meal.instructions) ? meal.instructions.length : 0}
              </div>
            </CardContent>
          </Card>
        ))}
